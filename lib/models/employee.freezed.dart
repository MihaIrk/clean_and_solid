...
abstract class $EmployeeCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, int age, String post, String id});
}
...
class _$_Employee implements _Employee {
  ...
  @override
  String toString() {
    return 'Employee(name: $name, age: $age, post: $post, id: $id)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, age, post, id);
